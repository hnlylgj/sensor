...
public class LGJCloudBusChannelService extends Service 
{
	...
	public static LGJCloudBusChannelService CurrentLGJCloudBusChannelService;
    ...
    private TimerTask mTimerTask;
 	          ...
 	          {  
 	        	 ...
 	        	 if(MyLGJNIOSocketBase!=null)
		   	     {  
 	        		...
 	        		if(MyLGJNIOSocketBase.MySocketChannel.socket().isConnected())
 	        		{
 					    ...
 					    if(ResetCount<6)
 					     ...
 					     {
 					    	MyStatusNotificationManager("Service Close:3");
							try
							{
								MyLGJNIOSocketBase.CloseConnect();
								MyLGJNIOSocketBase=null;
								MyLGJNIOSocketBase=new LGJNIOSocketBase();
								MyLGJNIOSocketBase.OpenConnect(this);	
								ResetCount=0;
							} 
							catch (IOException e) 
							{
 	        		...
 	        		{
 	        			MyStatusNotificationManager("Service Close:4");
 	        			try
						{
							MyLGJNIOSocketBase.CloseConnect();
							MyLGJNIOSocketBase=null;
	 ...
	 public LGJCloudBusChannelService()
	 {
		...
		// TODO Auto-generated method stub
         ...
         .commit();
   		  ...
   		  if(CloseFlagID==0)
   		  {
   		   ...
   		   MyStatusNotificationManager("Service Close:1");
   		  ...
   		  else
   		  {
   			  ...
   			  MyStatusNotificationManager("Service Close:2");
